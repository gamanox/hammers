...
(function() {
  var disable_scroll, enable_scroll, keydown, keys, preventDefault, showHide, wheel;
  ...
  $(function() {
    var center, centermap, initialize, mkr;
    ...
    if (window.location.pathname === "/home/contact") {
      initialize = function() {
        ...
        contentString = '<div id="infoquiondas">' + '<div id="siteNotice">' + '</div>' + '<h1 id="firstHeading" class="firstHeading">Hammers<br/>Electromechanical</h1>' + '<div id="bodyContent">' + '<p>Blvrd Puerta del Sol 1197-A<br/>Colinas de San Jerónimo<br/>Monterrey, N.L. 21132<br/><br/>t. +52 (81) 196-80151<br/><span class="blanco">t. </span>+52 (81) 196-80152</p>' + '<a class="email-info" href="mailto:info@hammers.mx">ENVIAR CORREO</a>';
